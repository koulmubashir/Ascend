        ...
        Binding(
            ...
            set: { wantsOn in
                ...
                Task {
                    ...
                    if existing == .denied {
                        permissionMessage = "You previously turned notifications off for Ascend. Turn them back on in Settings to get workout reminders."
                        showingPermissionAlert = true
                        return
                    }
                    ...
                    if !granted {
                        permissionMessage = "Turn notifications on for Ascend in Settings to get workout reminders."
                        showingPermissionAlert = true
                    }
                }
            }
