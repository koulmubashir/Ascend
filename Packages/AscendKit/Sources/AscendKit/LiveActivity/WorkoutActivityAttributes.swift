...
///
/// Lives in AscendKit because both the app (which starts and updates the activity)
...
/// which link ActivityKit; AscendKit stays free of it so the package still builds
