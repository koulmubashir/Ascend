...
///
/// These live in GymKit because both processes need them and an app extension
...
public enum SharedSessionCommands {
    ...
    public static let appGroup = "group.com.mubashirkoul.GymTracker"
...
/// ActivityKit conformance, guarded so GymKit still builds for watchOS.
@available(iOS 16.1, *)
